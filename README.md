...
- `fetch_inverse_swap_markets(self, params: Any)`
...
- `set_balance_cache(self, client: Client, type: Any, subType: Any, subscriptionHash: Any, params: Any)`
- `load_balance_snapshot(self, client: Client, messageHash: Any, type: Any, subType: Any)`

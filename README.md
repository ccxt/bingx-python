...
- `fetch_inverse_swap_markets(self, params: object)`
...
- `custom_encode(self, params: dict)`
- `describe(self)`
...
- `set_margin(self, symbol: str, amount: float, params: dict = {})`
...
- `spot_v2_public_get_quote_bookticker(request)`
- `spot_v2_public_get_quote_depth(request)`
- `spot_v2_public_get_quote_historicalklines(request)`
- `spot_v2_public_get_quote_historicaltrades(request)`
- `spot_v2_public_get_quote_klines(request)`
- `spot_v2_public_get_quote_price(request)`
- `spot_v2_public_get_quote_ticker(request)`
- `spot_v2_public_get_quote_trades(request)`
...
- `swap_v2_private_get_trade_positionhistory(request)`
...
- `cswap_v2_private_post_trade_order(request)`
...
- `account_v1_private_get_account_apirestrictions(request)`
...
- `wealth_v1_private_get_product_dual_currency_pre_order(request)`
- `wealth_v1_private_get_product_dual_currency_position(request)`
- `wealth_v1_private_get_product_dual_currency_order_records(request)`
- `wealth_v1_private_post_product_dual_currency_invest_asset_list(request)`
- `wealth_v1_private_post_product_dual_currency_order(request)`
...
- `set_balance_cache(self, client: Client, type: object, subType: Str, subscriptionHash: str, params: dict)`
- `load_balance_snapshot(self, client: Client, messageHash: str, type: object, subType: Str)`
- `watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params: dict = {})`
- `set_positions_cache(self, client: Client, type: Str, symbols: Strings = None)`
- `load_positions_snapshot(self, client: Client, messageHash: str, type: Str)`
